<x-app-layout>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-primary btn-sm" onclick="nuevoRol()">
                        ...
                        <table id="roles-table" class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-info" title="Permisos">
                                ...
                                <tr>
                                    <td>2</td>
                                    <td>Usuario</td>
                                    <td>Acceso básico al sistema</td>
                                    <td>1</td>
                                    <td>5</td>
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
    ...
    <script>
        ...
        function nuevoRol() {
            showInfo('Nuevo Rol', 'Funcionalidad para crear nuevo rol');
            // Lógica para crear nuevo rol
        }
    </script>
    @endpush
</x-app-layout>
