...
<head>
	...
	<title>Sistema de gestion de creditos</title>
...
$copa_background_login_custom = Variable::where('nombre', '=', 'copa_background_login_custom')->first()?->valor ?? '0';
$background_login_custom_path = Variable::where('nombre', '=', 'background_login_custom_path')->first()?->valor ?? null;
// $copa_background_login_custom = session('copa_background_login_custom');
// $background_login_custom_path = session('background_login_custom_path');
?>
	<style>
		<?php 
		/* #$copa_background_login_custom = 1; */
		if($copa_background_login_custom == '0' && $background_login_custom_path != null){
		?>
			body, html {
			height: 100%;
			background-repeat: no-repeat;
			background: url('<?= $background_login_custom_path ?>') center top no-repeat;
			background-repeat: no-repeat;
		...
		<?php 
			...
			body, html {
				height: 100%;
				background-repeat: no-repeat;
				background: url('/build/sgc_theme/images/dashboard-bg2.png') center top no-repeat;
				background-repeat: no-repeat;
				background-size: cover;
			}
		<?php
		...
		<div class="row">
			<div class="card card-default login-box">
				...
				<div class="card-body">
					...
					<a href="{{ route('register') }}" class="login-buttons forgot-password" style="margin-top: 10px;">
						Crear nueva cuenta
					</a>
